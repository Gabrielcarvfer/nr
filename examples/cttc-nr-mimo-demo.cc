...
main(int argc, char* argv[])
{
    ...
    // The number of rows and columns of antennas of gNB and UE
    uint16_t numRowsGnb = 2;
    uint16_t numColumnsGnb = 4;
    uint16_t numRowsUe = 2;
    uint16_t numColumnsUe = 2;
    // The number of vertical and horizontal ports of gNB and UE
    uint16_t numVPortsGnb = 1;
    uint16_t numHPortsGnb = 2;
    uint16_t numVPortsUe = 1;
    uint16_t numHPortsUe = 2;
    // Whether gNB and UE antenna arrays are x-polarized
    bool xPolGnb = false;
    bool xPolUe = false;
    // The polarization slant angle in case of x-polarized
    ...
    cmd.AddValue("numVPortsGnb",
                 ...
                 numVPortsGnb);
    cmd.AddValue("numVPortsUe", "Number of vertical ports of the antenna at the UE", numVPortsUe);
    cmd.AddValue("numHPortsGnb", "Number of horizontal ports of the antenna the gNB", numHPortsGnb);
    cmd.AddValue("numHPortsUe", "Number of horizontal ports of the antenna at the UE", numHPortsUe);
    ...
    nrHelper->SetGnbAntennaAttribute("IsDualPolarized", BooleanValue(xPolGnb));
    ...
    nrHelper->SetUeAntennaAttribute("IsDualPolarized", BooleanValue(xPolUe));
