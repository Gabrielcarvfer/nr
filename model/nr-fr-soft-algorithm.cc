    ...
    static TypeId tid =
        TypeId("ns3::NrFrSoftAlgorithm")
            ...
            .AddAttribute("UlEdgeSubBandOffset",
                          ...
                          UintegerValue(0),
                          MakeUintegerAccessor(&NrFrSoftAlgorithm::m_ulEdgeSubBandOffset),
            ...
            .AddAttribute("DlEdgeSubBandOffset",
                          ...
                          UintegerValue(0),
                          MakeUintegerAccessor(&NrFrSoftAlgorithm::m_dlEdgeSubBandOffset),
                          MakeUintegerChecker<uint8_t>())
            .AddAttribute(
                "DlEdgeSubBandwidth",
            ...
            .AddAttribute(
                ...
                UintegerValue(20),
                MakeUintegerAccessor(&NrFrSoftAlgorithm::m_edgeSubBandThreshold),
                MakeUintegerChecker<uint8_t>())
...
void
NrFrSoftAlgorithm::DoReportDlCqiInfo(
...
void
NrFrSoftAlgorithm::DoReportUlCqiInfo(
...
void
NrFrSoftAlgorithm::DoReportUeMeas(uint16_t rnti, NrRrcSap::MeasResults measResults)
{
...
void
NrFrSoftAlgorithm::DoRecvLoadInformation(NrEpcX2Sap::LoadInformationParams params)
{
    NS_LOG_FUNCTION(this);
    NS_LOG_WARN("Method should not be called, because it is empty");
}
