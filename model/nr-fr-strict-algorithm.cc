...
{
    static TypeId tid =
        TypeId("ns3::NrFrStrictAlgorithm")
            ...
            .AddAttribute("UlEdgeSubBandOffset",
                          ...
                          UintegerValue(0),
                          MakeUintegerAccessor(&NrFrStrictAlgorithm::m_ulEdgeSubBandOffset),
                          MakeUintegerChecker<uint8_t>())
            .AddAttribute(
                "UlEdgeSubBandwidth",
            ...
            .AddAttribute("DlEdgeSubBandOffset",
                          ...
                          UintegerValue(0),
                          MakeUintegerAccessor(&NrFrStrictAlgorithm::m_dlEdgeSubBandOffset),
                          MakeUintegerChecker<uint8_t>())
            .AddAttribute(
                "DlEdgeSubBandwidth",
            ...
            .AddAttribute(
                ...
                UintegerValue(20),
                MakeUintegerAccessor(&NrFrStrictAlgorithm::m_edgeSubBandThreshold),
                MakeUintegerChecker<uint8_t>())
...
void
NrFrStrictAlgorithm::DoReportDlCqiInfo(
...
void
NrFrStrictAlgorithm::DoReportUlCqiInfo(
...
void
NrFrStrictAlgorithm::DoReportUeMeas(uint16_t rnti, NrRrcSap::MeasResults measResults)
{
...
void
NrFrStrictAlgorithm::DoRecvLoadInformation(NrEpcX2Sap::LoadInformationParams params)
{
    NS_LOG_FUNCTION(this);
