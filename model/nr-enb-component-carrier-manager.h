...
#ifndef NR_ENB_COMPONENT_CARRIER_MANAGER_H
#define NR_ENB_COMPONENT_CARRIER_MANAGER_H
 ...
 * Carrier Manager SAP* interface. The NrEnbComponentCarrierManager instance
 ...
 *
 * Similarly, NrEnbComponentCarrierManager instance communicates with MAC, and
...
class NrEnbComponentCarrierManager : public Object
{
  public:
    NrEnbComponentCarrierManager();
    ~NrEnbComponentCarrierManager() override;
    /**
     ...
     *         be kept by an NrEnbRlc instance
     */
     ...
     * NrEnbComponentCarrierManager object which will behave as a
  ...
  protected:
    ...
    struct NrUeInfo
    {
        ...
        std::map<uint8_t, NrEnbCmacSapProvider::LcInfo>
     ...
     * NrEnbComponentCarrierManager. So, NrEnbComponentCarrierManager class will receive function
     ...
     * implements NrEnbComponentCarrierManager base class e.g.:EnbMacMemberNrMacSapProvider
     * <NrEnbComponentCarrierManagerImpl>
     */
...
}; // end of class NrEnbComponentCarrierManager

} // end of namespace ns3

#endif /* NR_ENB_COMPONENT_CARRIER_MANAGER_H */
