...
void
NrFrHardAlgorithm::DoReportDlCqiInfo(
...
void
NrFrHardAlgorithm::DoReportUlCqiInfo(
...
void
NrFrHardAlgorithm::DoReportUeMeas(uint16_t rnti, NrRrcSap::MeasResults measResults)
{
...
void
NrFrHardAlgorithm::DoRecvLoadInformation(NrEpcX2Sap::LoadInformationParams params)
{
    NS_LOG_FUNCTION(this);
    NS_LOG_WARN("Method should not be called, because it is empty");
}
