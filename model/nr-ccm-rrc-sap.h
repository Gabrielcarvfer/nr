...
class NrCcmRrcSapProvider
{
  ...
  public:
    virtual ~NrCcmRrcSapProvider();

    /// LcsConfig structure
    struct LcsConfig
    {
        uint16_t componentCarrierId;     ///< component carrier ID
        NrEnbCmacSapProvider::LcInfo lc; ///< LC info
    ...
    /**
     * \brief Add a new UE in the NrEnbComponentCarrierManager.
     ...
     *
     */
    virtual void AddLc(NrEnbCmacSapProvider::LcInfo lcInfo, NrMacSapUser* msu) = 0;
    ...
    /**
     * \brief Add a new Bearer for the Ue in the NrEnbComponentCarrierManager.
     ...
     * \param msu a pointer to the NrMacSapUser, the NrEnbComponentCarrierManager
    ...
    /**
     * \brief Release an existing Data Radio Bearer for a Ue in the NrEnbComponentCarrierManager
     * \param rnti Radio Network Temporary Identity, an integer identifying the UE
     *             where the report originates from
     * \param lcid the Logical Channel Id
     ...
     *
     */
    virtual NrMacSapUser* ConfigureSignalBearer(NrEnbCmacSapProvider::LcInfo lcInfo,
...
class MemberNrCcmRrcSapProvider : public NrCcmRrcSapProvider
{
  public:
    ...
    void AddLc(NrEnbCmacSapProvider::LcInfo lcInfo, NrMacSapUser* msu) override;
    ...
    NrMacSapUser* ConfigureSignalBearer(NrEnbCmacSapProvider::LcInfo lcInfo,
...
template <class C>
void
MemberNrCcmRrcSapProvider<C>::AddLc(NrEnbCmacSapProvider::LcInfo lcInfo, NrMacSapUser* msu)
{
...
template <class C>
NrMacSapUser*
MemberNrCcmRrcSapProvider<C>::ConfigureSignalBearer(NrEnbCmacSapProvider::LcInfo lcInfo,
