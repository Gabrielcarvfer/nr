    ...
    static TypeId tid =
        TypeId("ns3::NrFfrSoftAlgorithm")
            ...
            .AddAttribute("UlEdgeSubBandOffset",
                          ...
                          UintegerValue(0),
                          MakeUintegerAccessor(&NrFfrSoftAlgorithm::m_ulEdgeSubBandOffset),
                          MakeUintegerChecker<uint8_t>())
            .AddAttribute(
                "UlEdgeSubBandwidth",
            ...
            .AddAttribute("DlEdgeSubBandOffset",
                          ...
                          UintegerValue(0),
                          MakeUintegerAccessor(&NrFfrSoftAlgorithm::m_dlEdgeSubBandOffset),
                          MakeUintegerChecker<uint8_t>())
            .AddAttribute(
                "DlEdgeSubBandwidth",
            ...
            .AddAttribute(
                ...
                UintegerValue(20),
                MakeUintegerAccessor(&NrFfrSoftAlgorithm::m_edgeSubBandThreshold),
                MakeUintegerChecker<uint8_t>())
...
void
NrFfrSoftAlgorithm::DoReportDlCqiInfo(
...
void
NrFfrSoftAlgorithm::DoReportUlCqiInfo(
...
void
NrFfrSoftAlgorithm::DoReportUeMeas(uint16_t rnti, NrRrcSap::MeasResults measResults)
{
...
void
NrFfrSoftAlgorithm::DoRecvLoadInformation(NrEpcX2Sap::LoadInformationParams params)
{
    NS_LOG_FUNCTION(this);
    NS_LOG_WARN("Method should not be called, because it is empty");
}
