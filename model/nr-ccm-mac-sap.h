...
{
  public:
    virtual ~NrCcmMacSapProvider();

    /**
     * \brief Add the Buffer Status Report to the list.
     * \param bsr NrEnbComponentCarrierManager used this function to
...
template <class C>
void
MemberNrCcmMacSapProvider<C>::ReportMacCeToScheduler(MacCeListElement_s bsr)
{
...
template <class C>
void
MemberNrCcmMacSapUser<C>::UlReceiveMacCe(MacCeListElement_s bsr, uint8_t componentCarrierId)
{
