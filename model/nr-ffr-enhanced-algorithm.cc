...
{
    static TypeId tid =
        TypeId("ns3::NrFfrEnhancedAlgorithm")
...
void
NrFfrEnhancedAlgorithm::DoReportDlCqiInfo(
...
void
NrFfrEnhancedAlgorithm::DoReportUlCqiInfo(
    const FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
    ...
    if (params.m_ulCqi.m_type == UlCqi_s::SRS)
    {
        ...
        {
            double sinr = nr::FfConverter::fpS11dot3toDouble(params.m_ulCqi.m_sinr.at(j));
...
double
NrFfrEnhancedAlgorithm::EstimateUlSinr(uint16_t rnti,
                                       uint16_t rb,
...
void
NrFfrEnhancedAlgorithm::DoReportUeMeas(uint16_t rnti, NrRrcSap::MeasResults measResults)
{
...
void
NrFfrEnhancedAlgorithm::DoRecvLoadInformation(NrEpcX2Sap::LoadInformationParams params)
{
    NS_LOG_FUNCTION(this);
    NS_LOG_WARN("Method should not be called, because it is empty");
}
