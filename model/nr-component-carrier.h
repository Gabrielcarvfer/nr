 ...
 * This is the parent class for both NrComponentCarrierBaseStation
 ...
 * \ingroup nr
 *
 * Defines a Base station, that is a NrComponentCarrier but with a cell Id.
 *
 */
class NrComponentCarrierBaseStation : public NrComponentCarrier
{
  public:
    /**
     * \brief Get the type ID.
    ...
    /**
     * \brief ~NrComponentCarrierBaseStation
     */
    ~NrComponentCarrierBaseStation() override;
