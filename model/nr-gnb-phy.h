...
{
    friend class MemberNrEnbCphySapProvider<NrGnbPhy>;
  ...
  public:
     ...
     */
    void SetEnbCphySapUser(NrEnbCphySapUser* s);
    /**
     * \brief Get the C PHY SAP provider
     * \return the C PHY SAP provider pointer
     */
    NrEnbCphySapProvider* GetEnbCphySapProvider();
  ...
  private:
     ...
     */
    void SetTddPattern(const std::vector<NrTddSlotType>& pattern);
     ...
     */
    static void GenerateStructuresFromPattern(const std::vector<NrTddSlotType>& pattern,
