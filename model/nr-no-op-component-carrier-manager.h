 ...
 * of NrEnbComponentCarrierManager of NrNoOpComponentCarrierManager.
 */

class NrNoOpComponentCarrierManager : public NrEnbComponentCarrierManager
{
    /// allow EnbMacMemberNrMacSapProvider<NrNoOpComponentCarrierManager> class friend access
    friend class EnbMacMemberNrMacSapProvider<NrNoOpComponentCarrierManager>;
  ...
  protected:
     ...
     * \param msu the MSU
     */
    virtual void DoAddLc(NrEnbCmacSapProvider::LcInfo lcInfo, NrMacSapUser* msu);
    /**
     ...
     * \param lcinfo the NrEnbCmacSapProvider::LcInfo
     * \param msu the MSU
     * \returns updated data radio bearer list
     */
    virtual NrMacSapUser* DoConfigureSignalBearer(NrEnbCmacSapProvider::LcInfo lcinfo,
                                                  NrMacSapUser* msu);
    /**
