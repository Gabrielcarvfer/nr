...
NrNoOpComponentCarrierManager::NrNoOpComponentCarrierManager()
{
    ...
    m_macSapProvider = new EnbMacMemberNrMacSapProvider<NrNoOpComponentCarrierManager>(this);
...
NrNoOpComponentCarrierManager::GetTypeId()
{
    static TypeId tid = TypeId("ns3::NrNoOpComponentCarrierManager")
                            .SetParent<NrEnbComponentCarrierManager>()
                            .SetGroupName("Nr")
...
{
    NS_LOG_FUNCTION(this);
    NrEnbComponentCarrierManager::DoInitialize();
}
...
void
NrNoOpComponentCarrierManager::DoAddLc(NrEnbCmacSapProvider::LcInfo lcInfo, NrMacSapUser* msu)
{
    NS_LOG_FUNCTION(this);
                                                      ...
                                                      NrMacSapUser* msu)
{
    ...
    for (uint16_t ncc = 0; ncc < m_noOfComponentCarriers; ncc++)
    {
        ...
        NrEnbCmacSapProvider::LcInfo lci;
        lci.rnti = rnti;
        lci.lcId = lcid;
        lci.lcGroup = lcGroup;
        lci.qci = bearer.qci;
...
NrMacSapUser*
NrNoOpComponentCarrierManager::DoConfigureSignalBearer(NrEnbCmacSapProvider::LcInfo lcinfo,
                                                       NrMacSapUser* msu)
{
    NS_LOG_FUNCTION(this);
...
void
NrNoOpComponentCarrierManager::DoUlReceiveMacCe(MacCeListElement_s bsr, uint8_t componentCarrierId)
{
    NS_LOG_FUNCTION(this);
...
void
NrRrComponentCarrierManager::DoUlReceiveMacCe(MacCeListElement_s bsr, uint8_t componentCarrierId)
{
    NS_LOG_FUNCTION(this);
