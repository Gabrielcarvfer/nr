...
NS_OBJECT_ENSURE_REGISTERED(NrComponentCarrierBaseStation);

TypeId
NrComponentCarrierBaseStation::GetTypeId()
{
    static TypeId tid = TypeId("ns3::NrComponentCarrierBaseStation")
                            .SetParent<NrComponentCarrier>()
                            .AddConstructor<NrComponentCarrierBaseStation>();
    return tid;
}

NrComponentCarrierBaseStation::NrComponentCarrierBaseStation()
    : NrComponentCarrier()
{
    NS_LOG_FUNCTION(this);
}
...
uint16_t
NrComponentCarrierBaseStation::GetCellId() const
{
    return m_cellId;
}

void
NrComponentCarrierBaseStation::SetCellId(uint16_t cellId)
{
