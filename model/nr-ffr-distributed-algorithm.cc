...
{
    static TypeId tid =
        TypeId("ns3::NrFfrDistributedAlgorithm")
            ...
            .AddAttribute(
                ...
                UintegerValue(20),
                MakeUintegerAccessor(&NrFfrDistributedAlgorithm::m_edgeSubBandRsrqThreshold),
...
void
NrFfrDistributedAlgorithm::DoReportDlCqiInfo(
...
void
NrFfrDistributedAlgorithm::DoReportUlCqiInfo(
...
void
NrFfrDistributedAlgorithm::DoReportUeMeas(uint16_t rnti, NrRrcSap::MeasResults measResults)
{
...
NrFfrDistributedAlgorithm::Calculate()
{
    NS_LOG_FUNCTION(this);
    m_calculationEvent =
        Simulator::Schedule(m_calculationInterval, &NrFfrDistributedAlgorithm::Calculate, this);
...
NrFfrDistributedAlgorithm::SendLoadInformation(uint16_t targetCellId)
{
    ...
    std::vector<NrEpcX2Sap::UlInterferenceOverloadIndicationItem>
        m_currentUlInterferenceOverloadIndicationList;
    std::vector<NrEpcX2Sap::UlHighInterferenceInformationItem>
        m_currentUlHighInterferenceInformationList;
    NrEpcX2Sap::RelativeNarrowbandTxBand m_currentRelativeNarrowbandTxBand;

    m_currentRelativeNarrowbandTxBand.rntpPerPrbList = m_dlEdgeRbgMap;

    NrEpcX2Sap::CellInformationItem cii;
    ...
    NrEpcX2Sap::LoadInformationParams params;
...
void
NrFfrDistributedAlgorithm::DoRecvLoadInformation(NrEpcX2Sap::LoadInformationParams params)
{
    NS_LOG_FUNCTION(this);
