 ...
 */
class NrEpcEnbApplication : public Application
{
    /// allow NrMemberEpcEnbS1SapProvider<NrEpcEnbApplication> class friend access
    friend class NrMemberEpcEnbS1SapProvider<NrEpcEnbApplication>;
    /// allow NrMemberEpcS1apSapEnb<NrEpcEnbApplication> class friend access
    friend class NrMemberEpcS1apSapEnb<NrEpcEnbApplication>;
  ...
  public:
     ...
     */
    NrEpcEnbApplication(Ptr<Socket> lteSocket, Ptr<Socket> lteSocket6, uint16_t cellId);
     ...
     */
    void SetS1SapUser(NrEpcEnbS1SapUser* s);

    /**
     *
     * \return the S1 SAP Provider
     */
    NrEpcEnbS1SapProvider* GetS1SapProvider();
  ...
  private:
     ...
     */
    void DoPathSwitchRequest(NrEpcEnbS1SapProvider::PathSwitchRequestParameters params);
    /**
...
#endif /* NR_EPC_ENB_APPLICATION_H */
