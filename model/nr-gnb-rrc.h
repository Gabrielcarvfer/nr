...
class NrUeManager : public Object
{
  ...
  public:
    /**
     * The state of the NrUeManager at the eNB RRC
     *
     */
    enum State
    {
  ...
  private:
     ...
     * seen by the NrUeManager at the eNB RRC. Exporting IMSI, cell ID, RNTI, old
     * state, and new state.
     */
...
class NrEnbRrc : public Object
{
  ...
  public:
     ...
     */
    void SetNrEnbCmacSapProvider(NrEnbCmacSapProvider* s, uint8_t pos);
     ...
     * \returns the CMAC SAP User interface offered to the MAC by this RRC
     */
    NrEnbCmacSapUser* GetNrEnbCmacSapUser(uint8_t pos);
     ...
     */
    void SetNrFfrRrcSapProvider(NrFfrRrcSapProvider* s, uint8_t index);
     ...
     *           RRC
     */
    NrFfrRrcSapUser* GetNrFfrRrcSapUser(uint8_t index);
     ...
     */
    void SetS1SapProvider(NrEpcEnbS1SapProvider* s);

    /**
     *
     * \return the S1 SAP user
     */
    NrEpcEnbS1SapUser* GetS1SapUser();
     ...
     * \param pos the position
     */
    void SetNrEnbCphySapProvider(NrEnbCphySapProvider* s, uint8_t pos);
     ...
     * \return s the CPHY SAP User interface offered to the PHY by this RRC
     */
    NrEnbCphySapUser* GetNrEnbCphySapUser(uint8_t pos);
     ...
     */
    void ConfigureCell(std::map<uint8_t, Ptr<NrComponentCarrierBaseStation>> ccPhyConf);

    /**
     * \brief Configure carriers.
     * \param ccPhyConf the component carrier configuration
     */
    void ConfigureCarriers(std::map<uint8_t, Ptr<NrComponentCarrierBaseStation>> ccPhyConf);
     ...
     * forwarding a packet coming from the NrEpcEnbApplication
     *
     * \param p the packet
     *
  ...
  private:
     ...
     *
     * \param params NrEpcEnbS1SapUser::InitialContextSetupRequestParameters
     */
     ...
     *
     * \param params NrEpcEnbS1SapUser::DataRadioBearerSetupRequestParameters
     */
     ...
     *
     * \param params NrEpcEnbS1SapUser::PathSwitchRequestAcknowledgeParameters
     */
     ...
     *
     * \param params NrEnbCmacSapUser::UeConfig
     */
  ...
  private:
    ...
    std::vector<NrEnbCmacSapUser*> m_cmacSapUser;
    /// Interface to the eNodeB MAC instance.
    std::vector<NrEnbCmacSapProvider*> m_cmacSapProvider;
    ...
    /// Receive API calls from the NrEnbComponentCarrierManager instance.
    NrCcmRrcSapUser* m_ccmRrcSapUser;
    /// Interface to the NrEnbComponentCarrierManager instance.
    ...
    std::vector<NrFfrRrcSapUser*> m_ffrRrcSapUser;
    ...
    NrEpcEnbS1SapProvider* m_s1SapProvider;
    /// Interface to receive messages from core network over the S1 protocol.
    NrEpcEnbS1SapUser* m_s1SapUser;

    /// Receive API calls from the eNodeB PHY instances.
    std::vector<NrEnbCphySapUser*> m_cphySapUser;
    /// Interface to the eNodeB PHY instances.
    std::vector<NrEnbCphySapProvider*> m_cphySapProvider;
