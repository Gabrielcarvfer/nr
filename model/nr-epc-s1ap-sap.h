 ...
 */
class NrEpcS1apSapEnb : public NrEpcS1apSap
{
  public:
...
/**
 * Template for the implementation of the NrEpcS1apSapEnb as a member
 * of an owner class of type C to which all methods are forwarded
 */
template <class C>
class NrMemberEpcS1apSapEnb : public NrEpcS1apSapEnb
{
  public:
    /**
     * Constructor
     ...
     * \param owner the owner class
     */
    NrMemberEpcS1apSapEnb(C* owner);

    // Delete default constructor to avoid misuse
    NrMemberEpcS1apSapEnb() = delete;

    // inherited from NrEpcS1apSapEnb
    /**
...
template <class C>
NrMemberEpcS1apSapEnb<C>::NrMemberEpcS1apSapEnb(C* owner)
    : m_owner(owner)
{
}
...
template <class C>
void
NrMemberEpcS1apSapEnb<C>::InitialContextSetupRequest(uint64_t mmeUeS1Id,
                                                     uint16_t enbUeS1Id,
...
template <class C>
void
NrMemberEpcS1apSapEnb<C>::PathSwitchRequestAcknowledge(
    uint64_t enbUeS1Id,
    uint64_t mmeUeS1Id,
    uint16_t cgi,
