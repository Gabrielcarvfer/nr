...
class NrTestRrc : public Object
{
    ...
    //   friend class EnbMacMemberNrGnbPhySapUser;
...
{
    //   friend class EnbMacMemberNrEnbCmacSapProvider;
    /// allow EnbMacMemberNrMacSapProvider<NrTestMac> class friend access
    friend class EnbMacMemberNrMacSapProvider<NrTestMac>;
    //   friend class EnbMacMemberFfMacSchedSapUser;
    //   friend class EnbMacMemberFfMacCschedSapUser;
    //   friend class EnbMacMemberNrGnbPhySapUser;
 ...
 * \ingroup nr-test
 *
 * \brief RRC stub providing a testing S1 SAP user to be used with the NrEpcEnbApplication
 */
class EpcTestRrc : public Object
{
    /// allow NrMemberEpcEnbS1SapUser<EpcTestRrc> class friend access
    friend class NrMemberEpcEnbS1SapUser<EpcTestRrc>;
  ...
  private:
    ...
    NrEpcEnbS1SapProvider* m_s1SapProvider; ///< S1 SAP provider
    NrEpcEnbS1SapUser* m_s1SapUser;         ///< S1 SAP user
};
