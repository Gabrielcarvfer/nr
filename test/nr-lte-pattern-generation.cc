...
class NrPatternTestCase : public TestCase
{
  ...
  private:
     ...
     */
    void TestPattern(const std::vector<NrTddSlotType>& pattern, const Result& result);
...
void
NrPatternTestCase::TestPattern(const std::vector<NrTddSlotType>& pattern, const Result& result)
{
