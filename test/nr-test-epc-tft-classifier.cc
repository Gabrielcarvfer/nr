...
class EpcTftClassifierTestCase : public TestCase
{
  public:
     ...
     * addresses
     */
    EpcTftClassifierTestCase(Ptr<NrEpcTftClassifier> c,
...
EpcTftClassifierTestCase::EpcTftClassifierTestCase(Ptr<NrEpcTftClassifier> c,
                                                   NrEpcTft::Direction d,
                                                   std::string sa,
                                                   std::string da,
                                                   uint16_t sp,
...
std::string
EpcTftClassifierTestCase::BuildNameString(Ptr<NrEpcTftClassifier> c,
                                          NrEpcTft::Direction d,
                                          std::string sa,
                                          std::string da,
                                          uint16_t sp,
 ...
 */
static NrEpcTftClassifierTestSuite g_lteTftClassifierTestSuite;
