...
NrTestMac::NrTestMac()
{
    ...
    //   m_enbPhySapUser = new EnbMacMemberNrGnbPhySapUser (this);
}
...
{
    NS_LOG_FUNCTION(this);
    m_s1SapUser = new NrMemberEpcEnbS1SapUser<EpcTestRrc>(this);
}
...
void
EpcTestRrc::SetS1SapProvider(NrEpcEnbS1SapProvider* s)
{
    m_s1SapProvider = s;
}
...
EpcTestRrc::DoInitialContextSetupRequest(
    NrEpcEnbS1SapUser::InitialContextSetupRequestParameters request)
{
}
