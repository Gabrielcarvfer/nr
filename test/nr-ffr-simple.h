...
class NrFfrSimple : public NrFfrAlgorithm
{
  public:
     ...
     * \param pdschConfigDedicated NrRrcSap::PdschConfigDedicated object
     */
  ...
  private:
    ...
    std::map<uint16_t, NrRrcSap::PdschConfigDedicated> m_ues; ///< UEs
    ...
    NrRrcSap::PdschConfigDedicated m_pdschConfigDedicated; ///< PDSCH config dedicated
