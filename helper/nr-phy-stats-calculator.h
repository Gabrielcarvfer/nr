...
#ifndef NR_PHY_STATS_CALCULATOR_H_
#define NR_PHY_STATS_CALCULATOR_H_
...
class NrPhyStatsCalculator : public NrStatsCalculator
{
  public:
     ...
     * \param componentCarrierId
     */
    static void ReportUeSinr(Ptr<NrPhyStatsCalculator> phyStats,
                             std::string path,
                             uint16_t cellId,
                             uint16_t rnti,
                             double sinrLinear,
     ...
     * \param interference
     */
    static void ReportInterference(Ptr<NrPhyStatsCalculator> phyStats,
                                   std::string path,
                                   uint16_t cellId,
...
#endif /* NR_PHY_STATS_CALCULATOR_H_ */
